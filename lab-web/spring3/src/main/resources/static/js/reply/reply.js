...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const deleteReply = (e) => {
       ...
       axios
            ...
            .then((response) => {
                ...
                // 댓글 목록 새로고침 
                getRepliesWithPostId(postId);   // 댓글 목록 새로고침
    ...
    const updateReply = (e) => {
       ...
       const textAreaId = `textArea#replyText_${replyId}`;  // 댓글 내용 입력 textarea 아이디
       ...
       const data = {replyText};    // {replyText: replyText} (오브젝트인데 키: 값 중 키를 생략), 요청 데이터 (수정할 댓글 내용)
       axios
            ...
            .catch((error) => console.log(error));   // 응답이 에러일 때 동작할 콜백을 등록함.
    };
    ...
    const makeReplyElement = (data) => {
        ...
        for (let reply of data) {
            ...
            <div class="card my-2">
               ...
               // 로그인한 사용자와 댓글 작성자가 같을 때만 삭제, 수정 버튼을 보여주겠다.
