    ...
    */
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authRequest) -> authRequest // 접근 권한을 설정할 수 있는 객체.
                ...
                // .authenticated(): 권한 여부에 상관없이 아이디/패스워드만 일치하면 접근을 허용하겠다는 메서드
        ...
        */
        ...
        // (1) SecurityConfig 클래스에서는 @EnableMethodSecurity 애너테이션을 설정해줘야됨.
        // (2) 각각의 컨트롤러 메서드에서 @PreAuthorize 또는 @PostAuthorize 애너테이션을 사용(@PostAuthorize는 많이 사용하지 않음).
        return http.build();
    }
